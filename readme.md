...
Full Stack developer with a solid understanding of frontend technologies, MVC frameworks, and Database designing. Building Single Page Applications with React.js for the client side, Node.js/Express/Laravel for the server side, MongoDB/MySQL/PostgreSQL for the database and developing REST APIs or GraphQL APIs.
